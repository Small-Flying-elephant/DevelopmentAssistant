package com.aiman.developmentofassistant.service;
...
import com.aiman.developmentofassistant.receiver.MAccessibilityServiceReceiver;
import com.aiman.developmentofassistant.utils.NotificationUtil;
...
public class MAccessibilityService extends AccessibilityService {
     ...
     * 辅助服务名称（包名+"/"+完整类名）
     */
    public static final String SERVCE_NAME = "com.aiman.developmentofassistant/com.aiman.developmentofassistant.service.MAccessibilityService";
    ...
    protected void onServiceConnected() {
        Log.d("aimans", "onServiceConnected: ");
        // 添加窗口
